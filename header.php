  ...
  <body data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top">
	  ...
	  <div class="collapse navbar-collapse flex-row-reverse" id="collapsibleNavbar">
		<ul class="navbar-nav">
		  <li class="nav-item">
			<a class="nav-link" href="index.php" style="font-size:28px;color:#ffffff;">Trang chủ</a>
		  </li>
		  <li class="nav-item">
			<a class="nav-link" href="product.php" style="font-size:28px;color:#ffffff;">Sản phẩm</a>
		  </li>
		  <li class="nav-item">
