...
<?php include 'header.php'; ?>
						...
						<div id="mycarousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<div class="carousel-item active">
									<img class="d-block w-100" src="img/Ban1.png" width="500px" height="400px">
									<!--slide text-->
								...
								<div class="carousel-item">
									<img class="d-block w-100" src="img/Ban2.jpg" width="500px" height="400px">
									<div class="carousel-caption d-none d-md-block">
								...
								<!--slide3-->
								<div class="carousel-item">
									<img class="d-block w-100" src="img/Ban3.jpg" width="500px" height="400px">
									<div class="carousel-caption d-none d-md-block">
										<h5>Tiêu đề Slide 1</h5>
										<p>Chú thích cho Slide 1</p>
									</div>
						...
						<div class="row">
							<div class="col-12 col-sm-9 py-3 container-fluid mt-3" style="background-color:#33a7b8;">
							...
							<div class="col-12 col-sm-3" style="background-color:#000000;">
								<img src="img/bor.png" style="width:100%;height:100%;">
							</div>
						</div>
					
						<center>
							<img src="img/gtfull.png" class="rounded-sm" style="width:90%">
				`		</center>
