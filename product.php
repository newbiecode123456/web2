...
<?php include 'header.php'; ?>
				...
				<div class="row">
					...
					<div class="col-12 col-md-4 py-2" style="background-color:#004c55;">
						<p class="bg-secondary text-white py-2">&ensp;Phân loại</p><hr width="70%">
						...
						<br><br>
						<p class="bg-secondary text-white py-2">&ensp;Giá</p><hr width="70%">
						<div class="m-4">
							<form>
								<label for="customRange"><button type="button" class="btn btn-outline-warning">Lọc:</button></label>
								&ensp;&ensp;
								<input type="range" class="form-range" id="customRange">
							</form>
						</div>
						<br><br>
						<p class="bg-secondary text-white py-2">&ensp;Sản phẩm khác</p><hr width="70%">
						...
						<a href="shopping_cart.php" title="Cart">View Cart</a><br>
								 <div class="row"> 
									...
									<div class="col-sm-6 col-md-3 py-2">
										<div class="product">
											<form method="post" action="product.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
												<p style="text-align:center;margin-top:20px;"> <img style="width: 100%" src="<?php echo $product_array[$key]["image"]; ?>" class="img-responsive" alt="<?php echo $product_array[$key]["name"]; ?>"></p>
												<div class="caption"> 
													<div class="blur"></div>
